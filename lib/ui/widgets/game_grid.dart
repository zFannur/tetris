          ...
          child: BlocConsumer<TetrisBloc, TetrisState>(
            listener: (context, state) async {
              if (state.linesCleared > 0) {
                context.read<ScoreCubit>().incrementScore(state.linesCleared);
              }
            ...
            builder: (context, state) {
              final grid =
                  state.board; // Получаем доску, уже состоящую из объектов Cell
              ...
              return Container(
                ...
                child: GridView.count(
                  ...
                  childAspectRatio: 1,
                  // Одно и то же соотношение сторон для всех устройств
                  physics: const NeverScrollableScrollPhysics(),
                  // Отключает скроллинг
                  children: List.generate(
                      AppConst.gridHeight * AppConst.gridWidth, (index) {
